...
namespace ttbar{
    ...
    struct GenLevelWeights{
        ...
        const double& weightPS_;
        const double& weightAlphasPDF_;

        const double& weightMEScale_;
        const double& weightMEFacScale_;
        const double& weightMERenScale_;

        const double& weightBFrag_;
        const double& weightBSemilep_;
    ...
    struct GenObjectIndices{
        GenObjectIndices(const int& genBjetFromTopIndex, const int& genAntiBjetFromTopIndex,
			 ...
			 const std::vector<int>& genExtraJetIndicesIso08_,
    ...
    struct RecoObjectIndices{
        RecoObjectIndices(const std::vector<int>& allLeptonIndices,
			  ...
			  const std::vector<int>& extraJetIndicesIso08_,
