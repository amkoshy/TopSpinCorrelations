#ifndef AnalyzerLooseKinReco_h
#define AnalyzerLooseKinReco_h
...
class AnalyzerLooseKinReco : public AnalyzerBaseClass{

public:
    
    /// Constructor
    AnalyzerLooseKinReco(const Era::Era era,
                    const std::vector<TString>& selectionStepsNoCategories);

    /// Destructor
    ~AnalyzerLooseKinReco(){}
