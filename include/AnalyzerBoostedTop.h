#ifndef AnalyzerBoostedTop_h
#define AnalyzerBoostedTop_h
...
class AnalyzerBoostedTop : public AnalyzerBaseClass{

public:
    
    /// Constructor
    AnalyzerBoostedTop(const std::vector<TString>& selectionStepsNoCategories);
