...
public:
    ...
    LuminosityScaleFactors(const Samples& samples, const double& luminosityInInversePb, const double& luminosityUncertaintyRelative, RootFileReader* const rootFileReader);
...
private:
    ...
    void produceScaleFactors(const Samples& samples, const double& luminosityInInversePb,const double& luminosityUncertaintyRelative);
