...
MkLumiWeightedUnfoldingHistos_file = open("scripts/MkLumiWeightedUnfoldingHistos.sh","w")

# Make File Lists for each era/channel

for era in eras:

    checkfile =  open("check_TUnfoldHistoFileLists_"+era+".txt","w")

    if not os.path.exists("TUnfoldHistoFileLists_"+era.replace("UL","")): os.makedirs("TUnfoldHistoFileLists_"+era.replace("UL",""))
    
    for channel in channels:

        for syst in nominal + expersysts + theorysysts + virtualsysts:

            file = open("TUnfoldHistoFileLists_"+era.replace("UL","")+"/TUnfoldHistoFileList_"+syst+"_"+channel+".txt","w")
            ...
            if (syst in nominal):
                ...
                for sample in datasamples:
                    ...
                    file.write("UnfoldingHistos_"+era.replace("UL","")+"/Nominal/"+channel+"/"+"histosTUnfold_"+channel+"_"+sample+".root\n")
                    if not os.path.exists("UnfoldingHistos_"+era.replace("UL","")+"/Nominal/"+channel+"/"+"histosTUnfold_"+channel+"_"+sample+".root"): checkfile.write("UnfoldingHistos_"+era.replace("UL","")+"/Nominal/"+channel+"/"+"histosTUnfold_"+channel+"_"+sample+".root\n")

            for sample in backgroundMCsamples + dyMCsamples + signalMCsamples:

                if (syst in nominal):

                    file.write("UnfoldingHistos_"+era.replace("UL","")+"/"+syst+"/"+channel+"/"+"histosTUnfold_"+channel+"_"+sample+"_"+era+".root\n")
                    ...
                    #file.write("UnfoldingHistos_"+era.replace("UL","")+"/Nominal/"+channel+"/"+"histosTUnfold_"+channel+"_"+sample+"_"+era+".root\n")
                    #if not os.path.exists("UnfoldingHistos_"+era.replace("UL","")+"/Nominal/"+channel+"/"+"histosTUnfold_"+channel+"_"+sample+"_"+era+".root"): checkfile.write("UnfoldingHistos_"+era.replace("UL","")+"/Nominal/"+channel+"/"+"histosTUnfold_"+channel+"_"+sample+"_"+era+".root\n")
    ...
    for syst in nominal + expersysts + theorysysts + virtualsysts:
        ...
        MkLumiWeightedUnfoldingHistos_file.write("python scripts/MkLumiWeightedUnfoldingHistos.py -y "+era+" -s "+syst+"\n")

        file = open("TUnfoldHistoFileLists_"+era.replace("UL","")+"/TUnfoldHistoFileList_"+syst+"_combined.txt","w")
...
if not os.path.exists("TUnfoldHistoFileLists_2016"): os.makedirs("TUnfoldHistoFileLists_2016")
    
for channel in channels:

    for syst in nominal + expersysts + theorysysts + virtualsysts:

        file = open("TUnfoldHistoFileLists_2016/TUnfoldHistoFileList_"+syst+"_"+channel+".txt","w")
...
for syst in nominal + expersysts + theorysysts + virtualsysts:
    ...
    file = open("TUnfoldHistoFileLists_2016/TUnfoldHistoFileList_"+syst+"_combined.txt","w")
...
if not os.path.exists("TUnfoldHistoFileLists_fullRun2UL"): os.makedirs("TUnfoldHistoFileLists_fullRun2UL")
    
for channel in channels:

    for syst in nominal + expersysts + theorysysts + virtualsysts:

        file = open("TUnfoldHistoFileLists_fullRun2UL/TUnfoldHistoFileList_"+syst+"_"+channel+".txt","w")
...
for syst in nominal + expersysts + theorysysts + virtualsysts:
    ...
    file = open("TUnfoldHistoFileLists_fullRun2UL/TUnfoldHistoFileList_"+syst+"_combined.txt","w")
...
MkLumiWeightedUnfoldingHistos_file.close()
