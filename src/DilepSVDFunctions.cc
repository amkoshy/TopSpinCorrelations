...
TString DilepSVDFunctions::SVD_GetSteering(TString channel, TString particle, TString quantity, TString special, TString syst)
{
    ...
    if ( concatenation.EndsWith("TopQuark_Pt") == true ) flag_lowersidebin = 5;
    if ( concatenation.EndsWith("TopAntiQuark_Pt") == true ) flag_lowersidebin = 5;
...
void DilepSVDFunctions::SVD_Tex(TString channel, TString particle, TString quantity, TString special, TString& channelTex, TString& particleTex, TString& quantityTex, TString& specialTex)
{
    ...
    } else if ( strcmp(particle, "Lepton") == 0 ) {
        particleTex.Append("l^{-}");
    } else if ( strcmp(particle, "AntiLepton") == 0 ) {
        particleTex.Append("l^{+}");
    ...
    } else if ( strcmp(particle, "BJet") == 0 ){
        particleTex.Append("BJet");
    } else if ( strcmp(particle, "AntiBJet") == 0 ){
        particleTex.Append("AntiBJet");
    } else if ( strcmp(particle, "BBbar") == 0 ){
        particleTex.Append("b#bar{b}");
    } else if ( strcmp(particle, "TopQuarks") == 0 ) {
        particleTex.Append("t / #bar{t}");
    } else if ( strcmp(particle, "TopQuark") == 0 ) {
        particleTex.Append("t");
    } else if ( strcmp(particle, "TopAntiQuark") == 0 ) {
        particleTex.Append("#bar{t}");
