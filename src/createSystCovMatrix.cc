...
const TH2D statCovValues(TString variable, TString channel)
{
    ...
    if(channel == "combined")
    {
        ...
        std::ifstream eeResult ("UnfoldingResults/Nominal/ee/"+variable+"Results.txt");
        std::ifstream emuResult ("UnfoldingResults/Nominal/emu/"+variable+"Results.txt");
        std::ifstream mumuResult ("UnfoldingResults/Nominal/mumu/"+variable+"Results.txt");
